...
register.controller('RegisterCtrl', ['$scope', 'AuthService', 'Notification', function ($scope, AuthService, Notification) {
...
register.controller('LoginCtrl', ['$scope', '$cookies', '$timeout', 'AuthService', 'Notification', function ($scope, $cookies, $timeout, AuthService, Notification) {
...
register.controller('LogoutCtrl', ['$scope', '$cookies', 'AuthService', 'Notification', function ($scope, $cookies, AuthService, Notification) {
    AuthService.logout()
        .then(function () {
            Notification.success("Çıkış Başarılı!");
            $cookies.remove('id');
